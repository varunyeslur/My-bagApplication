...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputNumber = (EditText) findViewById(R.id.register_phonenumber_input);
                ...
                if(!(dataSnapshot.child("Users").child(phonenumber).exists()))
                {
                    ...
                    RootRef.child("Users").child(phonenumber).updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task)
                        {
                            ...
                            {
                                Toast.makeText(RegisterActivity.this, "Your account is Succsesfully Registered", Toast.LENGTH_SHORT).show();
                                loadingBar.dismiss();
                            ...
                            {
                                loadingBar.dismiss();
                                Toast.makeText(RegisterActivity.this, "Registration of Account failed",Toast.LENGTH_SHORT).show();
                            }
